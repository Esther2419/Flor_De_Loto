      ...
      <header className="bg-[#050505] border-b border-[#C5A059]/30 sticky top-0 z-50 shadow-md h-20 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="flex justify-between items-center h-full">
            ...
            <div className="flex items-center gap-4 md:gap-8">
              ...
              <button 
                onClick={toggleCart}
                className="relative text-white hover:text-[#D4AF37] transition-colors p-1"
        ...
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 pointer-events-none">
          ...
          <a
            ...
            className="bg-[#25D366] hover:bg-[#20BA5C] text-white p-3 md:p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-[0_0_20px_rgba(37,211,102,0.5)] flex items-center justify-center group pointer-events-auto"
