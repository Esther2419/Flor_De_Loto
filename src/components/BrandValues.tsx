...
export default function BrandValues() {
  return (
    <section className="py-8 md:py-16 px-3 md:px-6 bg-white border-t border-[#C5A059]/10">
      <div className="max-w-6xl mx-auto">
        
        <div className="grid grid-cols-3 gap-2 md:gap-10 text-center">
          
          <div className="flex flex-col items-center group cursor-default">
            <div className="w-8 h-8 md:w-12 md:h-12 mb-2 md:mb-4 text-[#C5A059] group-hover:scale-110 transition-transform duration-500">
              <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1"><path d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
            </div>
            <h3 className="font-serif text-xs md:text-lg text-[#0A0A0A] mb-1 md:mb-2 leading-tight">Frescura Garantizada</h3>
            <p className="text-[9px] md:text-xs text-gray-500 uppercase tracking-wider leading-tight">Selección diaria del campo</p>
          </div>
          ...
          <div className="flex flex-col items-center group cursor-default">
            ...
            <h3 className="font-serif text-xs md:text-lg text-[#0A0A0A] mb-1 md:mb-2 leading-tight">Diseño de Autor</h3>
            <p className="text-[9px] md:text-xs text-gray-500 uppercase tracking-wider leading-tight">Arreglos únicos y modernos</p>
          </div>
          ...
          <div className="flex flex-col items-center group cursor-default">
            ...
            <h3 className="font-serif text-xs md:text-lg text-[#0A0A0A] mb-1 md:mb-2 leading-tight">Atención Personal</h3>
            <p className="text-[9px] md:text-xs text-gray-500 uppercase tracking-wider leading-tight">Cuidamos cada detalle</p>
          </div>
