      ...
      <footer className="bg-[#050505] text-[#C5A059] border-t border-[#C5A059]/20 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
             <div className="mb-4 relative w-16 h-16 opacity-80">
          ...
          <div className="text-center md:text-left">
            <h4 className="font-bold text-xs uppercase tracking-[0.2em] text-white mb-6">Contacto</h4>
            <div className="space-y-4 text-sm text-white/70 font-light">
              <p>
                <strong className="block text-[#C5A059]">Ubicación:</strong>
                Av. General Galindo frente a la Plazuela Tarija.
              </p>
              <p>
          ...
          <div className="text-center md:text-left">
            <h4 className="font-bold text-xs uppercase tracking-[0.2em] text-white mb-6">Explorar</h4>
            <ul className="space-y-2 text-sm text-white/70 mb-8">
              <li><Link href="/#categorias" className="hover:text-[#C5A059] transition-colors">Catálogo Completo</Link></li>
            ...
            <div className="flex justify-center md:justify-start gap-4">
               <a href="#" className="w-8 h-8 rounded-full border border-[#C5A059]/30 flex items-center justify-center hover:bg-[#C5A059] hover:text-black transition-all">
        ...
        <div className="border-t border-[#C5A059]/10 pt-8 text-center">
           <p className="text-[#C5A059]/40 text-[10px] tracking-widest uppercase">
